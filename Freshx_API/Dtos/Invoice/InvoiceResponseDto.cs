namespace Freshx_API.Dtos.Invoice
{
    public class InvoiceResponseDto
    {
        ...
        public ICollection<MedicalServiceRequestDto> MedicalServiceRequests { get; set; } // Dịch vụ y tế liên quan
        public string? ReceptionName { get; set; } // Optional: Tên tiếp nhận nếu cần
    }
}
